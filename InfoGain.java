...
public class InfoGain {
  ...
  public double getGainRatio(int attributeIndex){
	  // System.out.println( getSplitInfo(attributeIndex));
	  // System.out.println(MathUtils.div(getGain(attributeIndex), getSplitInfo(attributeIndex)));
  ...
  public double getGain(int attributeIndex){
	  ...
	  // System.out.println("InfoAttribute="+getInfoAttribute(attributeIndex));
	  // System.out.println("Gain="+(getEntropy() - getInfoAttribute(attributeIndex)));
